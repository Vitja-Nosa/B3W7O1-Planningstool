...
--
-- Host: localhost
-- Generation Time: Jan 02, 2022 at 03:44 PM
...
--
-- Table structure for table `planned_games`
--

CREATE TABLE `planned_games` (
  `id` int(11) NOT NULL,
  `name` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `time` datetime NOT NULL,
  `explained_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `players` text COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Indexes for table `planned_games`
--
ALTER TABLE `planned_games`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `planned_games`
--
ALTER TABLE `planned_games`
